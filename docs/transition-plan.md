...
> Status: Steps 1–2 are done — the app opens on the Now view (`features/now/now-view.js`, `core/now-state.js`) while something is scheduled, and on the Day Planner otherwise. Routines book their time in the unified scheduler.
